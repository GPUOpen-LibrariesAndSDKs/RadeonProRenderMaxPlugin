...
* All Rights Reserved
*
* This file contains data copied from public 3ds Max API samples.
* They are mostly numerical constants. This is the only way to determine IDs of some important parameters
*********************************************************************************************************************************/
...
// OSL (Open Shading Language) Map
const Class_ID OSLTEXMAP_CLASS_ID( 2140830621, 1875767309 );

// Multi-Output Channel Select Map, usually used with OSL Map
//const Class_ID MULTIOUTPUTTOTEXMAP_CLASS_ID(2305749756L, 1153266751L)
