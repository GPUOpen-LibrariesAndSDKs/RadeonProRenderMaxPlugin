...
// Diffuse
	...
	if ( isEnabled(FRUBERMTLV3_DIFFUSE_ENABLE) )
	{
		...
		shader.xSetValue(RPRX_UBER_MATERIAL_DIFFUSE_WEIGHT, 1.f);
...
// Reflection
	...
	if ( isEnabled(FRUBERMTLV3_REFLECTION_ENABLE) )
	{
		...
		/*if(reflectionMode == RPRX_UBER_MATERIAL_REFLECTION_MODE_METALNESS)
...
// Refraction
	...
	if ( isEnabled(FRUBERMTLV3_REFRACTION_ENABLE) )
	{
		...
		shader.xSetValue(RPRX_UBER_MATERIAL_REFRACTION_WEIGHT, 1.0f);
...
// Coating
	...
	if ( isEnabled(FRUBERMTLV3_COATING_ENABLE) )
	{
		...
		shader.xSetValue(RPRX_UBER_MATERIAL_COATING_WEIGHT, 1.f);
...
// Transparency
	...
	if ( isEnabled(FRUBERMTLV3_TRANSPARENCY_ENABLE) )
	{
		...
		//shader.xSetValue(RPRX_UBER_MATERIAL_TRANSPARENCY, 0.6f);
	}
