...
// Reflection
	...
	p_vals, RPR_UBER_MATERIAL_IOR_MODE_PBR, RPR_UBER_MATERIAL_IOR_MODE_METALNESS, PB_END,
...
// Refraction
	...
	FRUBERMTLV3_REFRACTION_ABSORPTION_COLOR, _T("RefractionAbsorptionColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.0f, 1.0f, 1.0f),
	p_ui, ROLLOUT_REFRACTION, TYPE_COLORSWATCH, IDC_UBER3_REFRACTION_ABSORPTION_COLOR,
	PB_END,

	FRUBERMTLV3_REFRACTION_ABSORPTION_COLOR_MAP, _T("RefractionAbsorptionColorTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV3_MAP_REFRACTION_ABSORPTION_COLOR,
	p_ui, ROLLOUT_REFRACTION, TYPE_TEXMAPBUTTON, IDC_UBER3_REFRACTION_ABSORPTION_COLOR_T,
	PB_END,
...
// Displacement
	...
	FRUBERMTLV3_REFRACTION_USE_SHADER_NORMAL, _T("RefractionUseShaderNormal"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_REFRACTION, TYPE_SINGLECHEKBOX, IDC_UBER3_REFRACTION_USE_SHADER_NORMAL,
	PB_END,

	FRUBERMTLV3_REFRACTION_NORMAL_MAP, _T("RefractionNormalTexmap"), TYPE_TEXMAP, 0, 0,
...
// Refraction
	...
	{ FRUBERMTLV3_MAP_REFRACTION_ABSORPTION_COLOR,{ FRUBERMTLV3_REFRACTION_ABSORPTION_COLOR_MAP, _T("Refraction Absorption Color") } },
	{ FRUBERMTLV3_MAP_REFRACTION_NORMAL,{ FRUBERMTLV3_REFRACTION_NORMAL_MAP, _T("Refraction Normal") } },
...
// Diffuse
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_DIFFUSE_WEIGHT, 0.0f);

	if ( isEnabled(FRUBERMTLV3_DIFFUSE_ENABLE) )
	{
		setColor(RPR_UBER_MATERIAL_INPUT_DIFFUSE_COLOR, FRUBERMTLV3_DIFFUSE_COLOR, FRUBERMTLV3_DIFFUSE_COLOR_MAP, MAP_FLAG_NOFLAGS);
		setFloat(RPR_UBER_MATERIAL_INPUT_DIFFUSE_WEIGHT, FRUBERMTLV3_DIFFUSE_WEIGHT, FRUBERMTLV3_DIFFUSE_WEIGHT_MAP, MAP_FLAG_NOGAMMA);
		setFloat(RPR_UBER_MATERIAL_INPUT_DIFFUSE_ROUGHNESS, FRUBERMTLV3_DIFFUSE_ROUGHNESS, FRUBERMTLV3_DIFFUSE_ROUGHNESS_MAP, MAP_FLAG_NOGAMMA);

		if ( isEnabled(FRUBERMTLV3_DIFFUSE_USE_SHADER_NORMAL) )
		{
			if ( isEnabled(FRUBERMTLV3_NORMAL_ENABLE) )
			{
				setMap(RPR_UBER_MATERIAL_INPUT_DIFFUSE_NORMAL, FRUBERMTLV3_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
			}
		}
		else
		{
			setMap(RPR_UBER_MATERIAL_INPUT_DIFFUSE_NORMAL, FRUBERMTLV3_DIFFUSE_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
		}

		setFloat(RPR_UBER_MATERIAL_INPUT_BACKSCATTER_WEIGHT, FRUBERMTLV3_DIFFUSE_BACKSCATTERING_WEIGHT,
			FRUBERMTLV3_DIFFUSE_BACKSCATTERING_WEIGHT_MAP, MAP_FLAG_NOGAMMA);

		float diffuseBackscatteringWeight = GetFromPb<float>(pblock, FRUBERMTLV3_DIFFUSE_BACKSCATTERING_WEIGHT);

		if (diffuseBackscatteringWeight > 0.0f)
		{
			isEnabled(FRUBERMTLV3_DIFFUSE_SEPARATE_BACKSCATTERING_COLOR) ?
				setColor(RPR_UBER_MATERIAL_INPUT_BACKSCATTER_COLOR, FRUBERMTLV3_DIFFUSE_BACKSCATTERING_COLOR,
					FRUBERMTLV3_DIFFUSE_BACKSCATTERING_COLOR_MAP, MAP_FLAG_NOFLAGS) :
				setColor(RPR_UBER_MATERIAL_INPUT_BACKSCATTER_COLOR, FRUBERMTLV3_DIFFUSE_COLOR,
					FRUBERMTLV3_DIFFUSE_COLOR_MAP, MAP_FLAG_NOFLAGS);
		}
	}

// Reflection
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFLECTION_WEIGHT, 0.0f);

	if ( isEnabled(FRUBERMTLV3_REFLECTION_ENABLE) )
	{
		setColor(RPR_UBER_MATERIAL_INPUT_REFLECTION_COLOR, FRUBERMTLV3_REFLECTION_COLOR, FRUBERMTLV3_REFLECTION_COLOR_MAP, MAP_FLAG_NOFLAGS);
		setFloat(RPR_UBER_MATERIAL_INPUT_REFLECTION_WEIGHT, FRUBERMTLV3_REFLECTION_WEIGHT, FRUBERMTLV3_REFLECTION_WEIGHT_MAP, MAP_FLAG_NOGAMMA);
		setFloat(RPR_UBER_MATERIAL_INPUT_REFLECTION_ROUGHNESS, FRUBERMTLV3_REFLECTION_ROUGHNESS, FRUBERMTLV3_REFLECTION_ROUGHNESS_MAP,
			MAP_FLAG_NOGAMMA);
		setFloat(RPR_UBER_MATERIAL_INPUT_REFLECTION_ANISOTROPY, FRUBERMTLV3_REFLECTION_ANISOTROPY, FRUBERMTLV3_REFLECTION_ANISOTROPY_MAP,
			MAP_FLAG_NOGAMMA);
		setFloat(RPR_UBER_MATERIAL_INPUT_REFLECTION_ANISOTROPY_ROTATION, FRUBERMTLV3_REFLECTION_ANISOTROPY_ROTATION,
		...
		{
			setFloat(RPR_UBER_MATERIAL_INPUT_REFLECTION_IOR, FRUBERMTLV3_REFLECTION_IOR, FRUBERMTLV3_REFLECTION_IOR_MAP, MAP_FLAG_NOGAMMA);
		}
		else if(RPR_UBER_MATERIAL_IOR_MODE_METALNESS == reflectionMode)
		{
			setFloat(RPR_UBER_MATERIAL_INPUT_REFLECTION_METALNESS, FRUBERMTLV3_REFLECTION_METALNESS, FRUBERMTLV3_REFLECTION_METALNESS_MAP,
				MAP_FLAG_NOGAMMA);
		}
		...
		if ( isEnabled(FRUBERMTLV3_REFLECTION_USE_SHADER_NORMAL) )
		{
			if ( isEnabled(FRUBERMTLV3_NORMAL_ENABLE) )
			{
				setMap(RPR_UBER_MATERIAL_INPUT_REFLECTION_NORMAL, FRUBERMTLV3_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
			}
		}
		else
		{
			setMap(RPR_UBER_MATERIAL_INPUT_REFLECTION_NORMAL, FRUBERMTLV3_REFLECTION_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
		}
	}

// Refraction
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFRACTION_WEIGHT, 0.0f);

	if ( isEnabled(FRUBERMTLV3_REFRACTION_ENABLE) )
	{
		setColor(RPR_UBER_MATERIAL_INPUT_REFRACTION_COLOR, FRUBERMTLV3_REFRACTION_COLOR, FRUBERMTLV3_REFRACTION_COLOR_MAP, MAP_FLAG_NOFLAGS);
		setFloat(RPR_UBER_MATERIAL_INPUT_REFRACTION_WEIGHT, FRUBERMTLV3_REFRACTION_WEIGHT, FRUBERMTLV3_REFRACTION_WEIGHT_MAP, MAP_FLAG_NOGAMMA);
		setFloat(RPR_UBER_MATERIAL_INPUT_REFRACTION_ROUGHNESS, FRUBERMTLV3_REFRACTION_ROUGHNESS, FRUBERMTLV3_REFRACTION_ROUGHNESS_MAP,
			MAP_FLAG_NOGAMMA);
		setFloat(RPR_UBER_MATERIAL_INPUT_REFRACTION_IOR, FRUBERMTLV3_REFRACTION_IOR, FRUBERMTLV3_REFRACTION_IOR_MAP, MAP_FLAG_NOGAMMA);

		BOOL isThinSuraface = GetFromPb<BOOL>(pblock, FRUBERMTLV3_REFRACTION_THIN_SURFACE);
		shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFRACTION_THIN_SURFACE, isThinSuraface);

		setColor(RPR_UBER_MATERIAL_INPUT_REFRACTION_ABSORPTION_COLOR, FRUBERMTLV3_REFRACTION_COLOR, FRUBERMTLV3_REFRACTION_COLOR_MAP,
			MAP_FLAG_NOFLAGS);
		setFloat(RPR_UBER_MATERIAL_INPUT_REFRACTION_ABSORPTION_DISTANCE, FRUBERMTLV3_REFRACTION_ABSORPTION_DISTANCE,
			FRUBERMTLV3_REFRACTION_ABSORPTION_DISTANCE_MAP, MAP_FLAG_NOGAMMA);
		setColor(RPR_UBER_MATERIAL_INPUT_REFRACTION_ABSORPTION_COLOR, FRUBERMTLV3_REFRACTION_ABSORPTION_COLOR,
			FRUBERMTLV3_REFRACTION_ABSORPTION_COLOR_MAP, MAP_FLAG_NOGAMMA);
		
		BOOL hasCaustics = GetFromPb<BOOL>(pblock, FRUBERMTLV3_REFRACTION_ALLOW_CAUSTICS);
		shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFRACTION_CAUSTICS, hasCaustics);

		if (isEnabled(FRUBERMTLV3_REFRACTION_USE_SHADER_NORMAL))
		{
			if (isEnabled(FRUBERMTLV3_NORMAL_ENABLE))
			{
				setMap(RPR_UBER_MATERIAL_INPUT_REFRACTION_NORMAL, FRUBERMTLV3_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
			}
		}
		else
		{
			setMap(RPR_UBER_MATERIAL_INPUT_REFRACTION_NORMAL, FRUBERMTLV3_REFRACTION_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
		}
	}

// Coating
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_COATING_WEIGHT, 0.0f);

	if ( isEnabled(FRUBERMTLV3_COATING_ENABLE) )
	{
		setColor(RPR_UBER_MATERIAL_INPUT_COATING_COLOR, FRUBERMTLV3_COATING_COLOR, FRUBERMTLV3_COATING_COLOR_MAP, MAP_FLAG_NOFLAGS);
		setFloat(RPR_UBER_MATERIAL_INPUT_COATING_WEIGHT, FRUBERMTLV3_COATING_WEIGHT, FRUBERMTLV3_COATING_WEIGHT_MAP, MAP_FLAG_NOGAMMA);
		setFloat(RPR_UBER_MATERIAL_INPUT_COATING_ROUGHNESS, FRUBERMTLV3_COATING_ROUGHNESS, FRUBERMTLV3_COATING_ROUGHNESS_MAP, MAP_FLAG_NOGAMMA);
		setFloat(RPR_UBER_MATERIAL_INPUT_COATING_IOR, FRUBERMTLV3_COATING_IOR, FRUBERMTLV3_COATING_IOR_MAP, MAP_FLAG_NOGAMMA);

		if ( isEnabled(FRUBERMTLV3_COATING_USE_SHADER_NORMAL) )
		{
			if ( isEnabled(FRUBERMTLV3_NORMAL_ENABLE) )
			{
				setMap(RPR_UBER_MATERIAL_INPUT_COATING_NORMAL, FRUBERMTLV3_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
			}
		}
		else
		{
			setMap(RPR_UBER_MATERIAL_INPUT_COATING_NORMAL, FRUBERMTLV3_COATING_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
		}

		setFloat(RPR_UBER_MATERIAL_INPUT_COATING_THICKNESS, FRUBERMTLV3_COATING_THICKNESS, FRUBERMTLV3_COATING_THICKNESS_MAP, MAP_FLAG_NOGAMMA);

		SetTransmissionColor(RPR_UBER_MATERIAL_INPUT_COATING_TRANSMISSION_COLOR, FRUBERMTLV3_COATING_TRANSMISSION_COLOR,
			FRUBERMTLV3_COATING_TRANSMISSION_COLOR_MAP, pblock, &mtlParser, shader);
	}

// Emissive
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_EMISSION_WEIGHT, 0.0f);

	if ( isEnabled(FRUBERMTLV3_EMISSIVE_ENABLE) )
	{
		setFloat(RPR_UBER_MATERIAL_INPUT_EMISSION_WEIGHT, FRUBERMTLV3_EMISSIVE_WEIGHT, FRUBERMTLV3_EMISSIVE_WEIGHT_MAP, MAP_FLAG_NOGAMMA);

		SetEmissiveColor(RPR_UBER_MATERIAL_INPUT_EMISSION_COLOR, FRUBERMTLV3_EMISSIVE_COLOR, FRUBERMTLV3_EMISSIVE_COLOR_MAP,
		...
		rpr_uint emissiveMode = isDoubleSided ? 2 : 1;
		shader.SetValue(RPR_UBER_MATERIAL_INPUT_EMISSION_MODE, emissiveMode);

		shader.SetEmissiveFlag(true);
	}

// Subsurface scattering
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_SSS_WEIGHT, 0.0f);

	if ( isEnabled(FRUBERMTLV3_SSS_ENABLE) )
	{
		setFloat(RPR_UBER_MATERIAL_INPUT_SSS_WEIGHT, FRUBERMTLV3_SSS_WEIGHT, FRUBERMTLV3_SSS_WEIGHT_MAP, MAP_FLAG_NOGAMMA);

		if ( isEnabled(FRUBERMTLV3_SSS_USE_DIFFUSE_COLOR) )
		{
			setColor(RPR_UBER_MATERIAL_INPUT_SSS_SCATTER_COLOR, FRUBERMTLV3_DIFFUSE_COLOR, FRUBERMTLV3_DIFFUSE_COLOR_MAP, MAP_FLAG_NOFLAGS);
		}
		else
		{
			setColor(RPR_UBER_MATERIAL_INPUT_SSS_SCATTER_COLOR, FRUBERMTLV3_SSS_COLOR, FRUBERMTLV3_SSS_COLOR_MAP, MAP_FLAG_NOFLAGS);
		}

		setPoint3(RPR_UBER_MATERIAL_INPUT_SSS_SCATTER_DISTANCE, FRUBERMTLV3_SSS_RADIUS, FRUBERMTLV3_SSS_RADIUS_MAP, MAP_FLAG_NOGAMMA);
		setFloat(RPR_UBER_MATERIAL_INPUT_SSS_SCATTER_DIRECTION, FRUBERMTLV3_SSS_DIRECTION, FRUBERMTLV3_SSS_DIRECTION_MAP, MAP_FLAG_NOGAMMA);

		BOOL multiScatter = GetFromPb<BOOL>(pblock, FRUBERMTLV3_SSS_MULTIPLE_SCATTERING);
		shader.SetValue(RPR_UBER_MATERIAL_INPUT_SSS_MULTISCATTER, multiScatter);
	}

// Transparency
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_TRANSPARENCY, 0.0f);

	if ( isEnabled(FRUBERMTLV3_TRANSPARENCY_ENABLE) )
	{
		setFloat(RPR_UBER_MATERIAL_INPUT_TRANSPARENCY, FRUBERMTLV3_TRANSPARENCY, FRUBERMTLV3_TRANSPARENCY_MAP, MAP_FLAG_NOGAMMA);
	}
