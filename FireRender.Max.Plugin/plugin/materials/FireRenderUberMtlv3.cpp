	...
	if ( isEnabled(FRUBERMTLV3_DIFFUSE_ENABLE) )
	{
		...
		if (diffuseBackscatteringWeight > 0.0f)
		{
			isEnabled(FRUBERMTLV3_DIFFUSE_SEPARATE_BACKSCATTERING_COLOR) ?
				...
				setColor(RPRX_UBER_MATERIAL_BACKSCATTER_COLOR, FRUBERMTLV3_DIFFUSE_COLOR,
...
// Refraction
	...
	if ( isEnabled(FRUBERMTLV3_REFRACTION_ENABLE) )
	{
		...
		setColor(RPRX_UBER_MATERIAL_REFRACTION_ABSORPTION_COLOR, FRUBERMTLV3_REFRACTION_ABSORPTION_COLOR,
		...
		if (isEnabled(FRUBERMTLV3_REFRACTION_USE_SHADER_NORMAL))
		{
			if (isEnabled(FRUBERMTLV3_NORMAL_ENABLE))
			{
				setMap(RPRX_UBER_MATERIAL_REFRACTION_NORMAL, FRUBERMTLV3_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
			}
		}
		else
		{
			setMap(RPRX_UBER_MATERIAL_REFRACTION_NORMAL, FRUBERMTLV3_REFRACTION_NORMAL_MAP, MAP_FLAG_NOGAMMA | MAP_FLAG_NORMALMAP);
		}
	}
