...
namespace
{
	static constexpr float RoughnessMulMin = 0.f;
...
static ParamBlockDesc2 pbDesc(
	...
	p_default, 1.0f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_DIFFUSE_COLOR_MUL, IDC_UBER_DIFFUSE_COLOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_DIFFUSE_COLOR, _T("DiffuseColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_DIFFUSE_COLOR, PB_END,
	...
	p_default, 1.f, p_range, 0.f, 1.f, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_DIFFUSE_WEIGHT_MUL, IDC_UBER_DIFFUSE_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_DIFFUSE_WEIGHT, _T("DiffuseWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_DIFFUSE_WEIGHT, PB_END,
	...
	p_default, 1.f, p_range, RoughnessMulMin, RoughnessMulMax, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_DIFFUSE_ROUGHNESS_MUL, IDC_UBER_DIFFUSE_ROUGHNESS_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_DIFFUSE_ROUGHNESS, _T("DiffuseRoughness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_DIFFUSE_ROUGHNESS, PB_END,
	...
	p_default, 1.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_COLOR_MUL, IDC_UBER_REFLECTION_COLOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFLECTION_COLOR, _T("ReflectionColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_COLOR, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_WEIGHT_MUL, IDC_UBER_REFLECTION_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFLECTION_WEIGHT, _T("ReflectionWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_WEIGHT, PB_END,
	...
	p_default, 0.5f, p_range, RoughnessMulMin, RoughnessMulMax, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_ROUGHNESS_MUL, IDC_UBER_REFLECTION_ROUGHNESS_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFLECTION_ROUGHNESS, _T("ReflectionRoughness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_ROUGHNESS, PB_END,
	...
	p_default, 0.0f, p_range, -FLT_MAX, FLT_MAX, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_ANISO_MUL, IDC_UBER_REFLECTION_ANISO_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.0f, p_range, 0.f, 1.0, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_ANISO_ROT_MUL, IDC_UBER_REFLECTION_ANISO_ROT_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFLECTION_ANISO_ROT, _T("ReflectionAnisoRot"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_ANISO_ROT, PB_END,
	...
	p_default, 1.5f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_IOR_MUL, IDC_UBER_REFLECTION_IOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFLECTION_IOR, _T("ReflectionIOR"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_IOR, PB_END,
	...
	p_default, 1.0f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_METALNESS_MUL, IDC_UBER_REFLECTION_METALNESS_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFLECTION_METALNESS, _T("ReflectionMetalness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_METALNESS, PB_END,
	...
	p_default, 1.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_COLOR_MUL, IDC_UBER_REFRACTION_COLOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFRACTION_COLOR, _T("RefractionColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFRACTION_COLOR, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_WEIGHT_MUL, IDC_UBER_REFRACTION_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFRACTION_WEIGHT, _T("RefractionWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFRACTION_WEIGHT, PB_END,
	...
	p_default, 0.5f, p_range, RoughnessMulMin, RoughnessMulMax, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_ROUGHNESS_MUL, IDC_UBER_REFRACTION_ROUGHNESS_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFRACTION_ROUGHNESS, _T("RefractionRoughness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFRACTION_ROUGHNESS, PB_END,
	...
	p_default, 1.5f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_IOR_MUL, IDC_UBER_REFRACTION_IOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_REFRACTION_IOR, _T("RefractionIOR"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFRACTION_IOR, PB_END,
	...
	p_default, 1.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_COLOR_MUL, IDC_UBER_COAT_COLOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_COAT_COLOR, _T("CoatColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_COLOR, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_WEIGHT_MUL, IDC_UBER_COAT_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_COAT_WEIGHT, _T("CoatWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_WEIGHT, PB_END,
	...
	p_default, 1.0f, p_range, RoughnessMulMin, RoughnessMulMax, p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_ROUGHNESS_MUL, IDC_UBER_COAT_ROUGHNESS_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_COAT_ROUGHNESS, _T("CoatRoughness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_ROUGHNESS, PB_END,
	...
	p_default, 1.5f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_IOR_MUL, IDC_UBER_COAT_IOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_COAT_IOR, _T("CoatIOR"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_IOR, PB_END,
	...
	p_default, 1.0f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_METALNESS_MUL, IDC_UBER_COAT_METALNESS_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_COAT_METALNESS, _T("CoatMetalness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_METALNESS, PB_END,
	...
	p_default, 1.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_SUBSURFACE_COLOR_MUL, IDC_UBER_SSS_SUBSURFACE_COLOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_SSS_SUBSURFACE_COLOR, _T("SSSSubSurfaceColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_SSS, TYPE_COLORSWATCH, IDC_UBER_SSS_SUBSURFACE_COLOR, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_WEIGHT_MUL, IDC_UBER_SSS_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_SSS_WEIGHT, _T("SSSWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_SSS, TYPE_COLORSWATCH, IDC_UBER_SSS_WEIGHT, PB_END,
	...
	p_default, 0.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_SCATTERCOLOR_MUL, IDC_UBER_SSS_SCATTERCOLOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_SSS_SCATTER_COLOR, _T("SSSScatterColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_SSS, TYPE_COLORSWATCH, IDC_UBER_SSS_SCATTERCOLOR, PB_END,
	...
	p_default, 1.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_SCATTERAMOUNT_MUL, IDC_UBER_SSS_SCATTERAMOUNT_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.f, p_range, -FLT_MAX, FLT_MAX, p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_DIRECTION_MUL, IDC_UBER_SSS_DIRECTION_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_ABSORPTION, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_ABSORPTION_MUL, IDC_UBER_SSS_ABSORPTION_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_SSS_ABSORPTION, _T("SSSAbsorption"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_ABSORPTION, TYPE_COLORSWATCH, IDC_UBER_SSS_ABSORPTION, PB_END,
	...
	p_default, 1.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_ABSORPTION, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_ABSORPTION_DIST_MUL, IDC_UBER_SSS_ABSORPTION_DIST_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 1.f, p_range, 0.f, 1.0f, p_ui, ROLLOUT_EMISSIVE, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_EMISSIVE_COLOR_MUL, IDC_UBER_EMISSIVE_COLOR_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_EMISSIVE_COLOR, _T("EmissiveColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_EMISSIVE, TYPE_COLORSWATCH, IDC_UBER_EMISSIVE_COLOR, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, ROLLOUT_EMISSIVE, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_EMISSIVE_WEIGHT_MUL, IDC_UBER_EMISSIVE_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_EMISSIVE_WEIGHT, _T("EmissiveWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.f, 1.f, 1.f), p_ui, ROLLOUT_EMISSIVE, TYPE_COLORSWATCH, IDC_UBER_EMISSIVE_WEIGHT, PB_END,
	...
	p_default, 1.f, p_range, 0.f, 1.f, p_ui, ROLLOUT_OVERALL, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_MAT_OPACITY_MUL, IDC_UBER_MAT_OPACITY_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 1.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_OVERALL, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_MAT_NORMAL_MUL, IDC_UBER_MAT_NORMAL_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_MAT_NORMAL, _T("MaterialNormal"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, Color(1.0f, 1.0f, 1.0f), p_ui, ROLLOUT_OVERALL, TYPE_COLORSWATCH, IDC_UBER_MAT_NORMAL, PB_END,
	...
	p_default, 1.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_OVERALL, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_MAT_DISPLACE_MUL, IDC_UBER_MAT_DISPLACE_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 1.f, p_range, 0.f, FLT_MAX, p_ui, ROLLOUT_OVERALL, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_MAT_BUMP_MUL, IDC_UBER_MAT_BUMP_MUL_S, SPIN_AUTOSCALE, PB_END,
