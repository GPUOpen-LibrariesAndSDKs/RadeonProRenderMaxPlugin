...
static ParamBlockDesc2 pbDesc(
	...
	p_default, 1.f, p_range, 0.f, 1.f, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_DIFFUSE_WEIGHT_MUL, IDC_UBER_DIFFUSE_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 1.f, p_range, RoughnessMulMin, RoughnessMulMax, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_DIFFUSE_ROUGHNESS_MUL, IDC_UBER_DIFFUSE_ROUGHNESS_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_WEIGHT_MUL, IDC_UBER_REFLECTION_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.5f, p_range, RoughnessMulMin, RoughnessMulMax, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_ROUGHNESS_MUL, IDC_UBER_REFLECTION_ROUGHNESS_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_WEIGHT_MUL, IDC_UBER_REFRACTION_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.5f, p_range, RoughnessMulMin, RoughnessMulMax, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_ROUGHNESS_MUL, IDC_UBER_REFRACTION_ROUGHNESS_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_WEIGHT_MUL, IDC_UBER_COAT_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 1.0f, p_range, RoughnessMulMin, RoughnessMulMax, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_ROUGHNESS_MUL, IDC_UBER_COAT_ROUGHNESS_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_WEIGHT_MUL, IDC_UBER_SSS_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 1.f, p_range, 0.f, 1.0f, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_EMISSIVE_COLOR_MUL, IDC_UBER_EMISSIVE_COLOR_MUL_S, SPIN_AUTOSCALE, PB_END,
	...
	p_default, 0.f, p_range, 0.f, 1.f, p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_EMISSIVE_WEIGHT_MUL, IDC_UBER_EMISSIVE_WEIGHT_MUL_S, SPIN_AUTOSCALE, PB_END,
