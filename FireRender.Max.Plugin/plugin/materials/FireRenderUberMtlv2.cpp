...
static ParamBlockDesc2 pbDesc(
	...
	p_default, RPR_UBER_MATERIAL_IOR_MODE_PBR,
	...
	p_default, RPR_MATERIAL_INPUT_UBER_COATING_MODE,
...
void FRMTLCLASSNAME(UberMtlv2)::SetupReflection(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOFLAGS);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_REFLECTION_COLOR, value);
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_REFLECTION_ANISOTROPY, value);
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_REFLECTION_ANISOTROPY_ROTATION, value);
	...
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_REFLECTION_MODE, reflectionMode);
	...
	if (RPR_UBER_MATERIAL_IOR_MODE_PBR == reflectionMode)
	{
		...
		inputId = RPR_MATERIAL_INPUT_UBER_REFLECTION_IOR;
	}
	else if (RPR_UBER_MATERIAL_IOR_MODE_METALNESS == reflectionMode)
	{
		...
		inputId = RPR_MATERIAL_INPUT_UBER_REFLECTION_METALNESS;
	}
	else
	{
...
void FRMTLCLASSNAME(UberMtlv2)::SetupRefraction(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOFLAGS);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_REFRACTION_COLOR, value);
	...
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_REFRACTION_THIN_SURFACE, bThinSuraface);
}
...
void FRMTLCLASSNAME(UberMtlv2)::SetupCoating(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOFLAGS);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_COATING_COLOR, value);
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_COATING_WEIGHT, value);
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_COATING_ROUGHNESS, value);

	// COATING REFLECTION MODE
	rpr_int inputId = 0;

	int coatingMode = GetFromPb<int>(pblock, FRUBERMTLV2_COAT_MODE);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_COATING_MODE, coatingMode);
	...
	if (coatingMode == RPR_UBER_MATERIAL_IOR_MODE_PBR)
	{
		...
		inputId = RPR_MATERIAL_INPUT_UBER_COATING_IOR;
	}
	else if (coatingMode == RPR_UBER_MATERIAL_IOR_MODE_METALNESS)
	{
		...
		inputId = RPR_MATERIAL_INPUT_UBER_COATING_METALNESS;
	}
	else
	{
		// UI is not aligned with the code
...
void FRMTLCLASSNAME(UberMtlv2)::SetupSSS(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_SSS_SCATTER_DIRECTION, value);

	// SSS SINGLESCATTERING
	BOOL bSingleScattering = GetFromPb<BOOL>(pblock, FRUBERMTLV2_SSS_SINGLESCATTERING);
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_SSS_MULTISCATTER, bSingleScattering ? 0 : 1);
...
void FRMTLCLASSNAME(UberMtlv2)::SetupEmissive(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	shader.SetValue(RPR_MATERIAL_INPUT_UBER_EMISSION_MODE, paramValue);
