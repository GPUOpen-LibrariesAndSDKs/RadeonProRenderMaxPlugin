...
static ParamBlockDesc2 pbDesc(
	0, _T("UberMtlv2Pbdesc"), 0, &FRMTLCLASSNAME(UberMtlv2)::ClassDescInstance,
	...
	p_default, DiffuseColorMulDefault,
	p_range, ColorMulMin, ColorMulMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_DIFFUSE_COLOR_MUL, IDC_UBER_DIFFUSE_COLOR_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_DIFFUSE_COLOR, _T("DiffuseColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, DiffuseColor,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_DIFFUSE_COLOR,
	PB_END,

	FRUBERMTLV2_DIFFUSE_COLOR_MAP, _T("DiffuseColorTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_DIFFUSE_COLOR,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_DIFFUSE_COLOR_T,
	PB_END,

	FRUBERMTLV2_DIFFUSE_COLOR_USEMAP, _T("DiffuseColorUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_DIFFUSE_COLOR_USEMAP,
	PB_END,

	// Diffuse Weight
	FRUBERMTLV2_DIFFUSE_WEIGHT_MUL, _T("DiffuseWeightMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, DiffuseWeightDefault,
	p_range, WeightMin, WeightMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_DIFFUSE_WEIGHT_MUL, IDC_UBER_DIFFUSE_WEIGHT_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_DIFFUSE_WEIGHT, _T("DiffuseWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, DiffuseWeight,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_DIFFUSE_WEIGHT,
	PB_END,

	FRUBERMTLV2_DIFFUSE_WEIGHT_MAP, _T("DiffuseWeightTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_DIFFUSE_WEIGHT,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_DIFFUSE_WEIGHT_T,
	PB_END,

	FRUBERMTLV2_DIFFUSE_WEIGHT_USEMAP, _T("DiffuseWeightUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_DIFFUSE_WEIGHT_USEMAP,
	PB_END,

	// Diffuse Roughness
	FRUBERMTLV2_DIFFUSE_ROUGHNESS_MUL, _T("DiffuseRoughnessMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, DiffuseRoughnessMulDefault,
	p_range, RoughnessMulMin, RoughnessMulMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_DIFFUSE_ROUGHNESS_MUL, IDC_UBER_DIFFUSE_ROUGHNESS_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_DIFFUSE_ROUGHNESS, _T("DiffuseRoughness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, DiffuseRoughness,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_DIFFUSE_ROUGHNESS,
	PB_END,

	FRUBERMTLV2_DIFFUSE_ROUGHNESS_MAP, _T("DiffuseRoughnessMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_DIFFUSE_ROUGHNESS,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_DIFFUSE_ROUGHNESS_T,
	PB_END,

	FRUBERMTLV2_DIFFUSE_ROUGHNESS_USEMAP, _T("DiffuseRoughnessUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_DIFFUSE_ROUGHNESS_USEMAP,
	PB_END,

	// Reflection Color
	FRUBERMTLV2_REFLECTION_COLOR_MUL, _T("ReflectionColorMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, ReflectionColorMulDefault,
	p_range, ColorMulMin, ColorMulMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_COLOR_MUL, IDC_UBER_REFLECTION_COLOR_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFLECTION_COLOR, _T("ReflectionColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, ReflectionColor,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_COLOR,
	PB_END,

	FRUBERMTLV2_REFLECTION_COLOR_MAP, _T("ReflectionColorTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFLECTION_COLOR,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFLECTION_COLOR_T,
	PB_END,

	FRUBERMTLV2_REFLECTION_COLOR_USEMAP, _T("ReflectionColorUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFLECTION_COLOR_USEMAP,
	PB_END,

	// Reflection Weight
	FRUBERMTLV2_REFLECTION_WEIGHT_MUL, _T("ReflectionWeightMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, ReflectionWeightDefault,
	p_range, WeightMin, WeightMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_WEIGHT_MUL,
		IDC_UBER_REFLECTION_WEIGHT_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFLECTION_WEIGHT, _T("ReflectionWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, ReflectionWeight,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_WEIGHT,
	PB_END,

	FRUBERMTLV2_REFLECTION_WEIGHT_MAP, _T("ReflectionWeightTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFLECTION_WEIGHT,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFLECTION_WEIGHT_T,
	PB_END,

	FRUBERMTLV2_REFLECTION_WEIGHT_USEMAP, _T("ReflectionWeightUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFLECTION_WEIGHT_USEMAP,
	PB_END,

	// Reflection Roughness
	FRUBERMTLV2_REFLECTION_ROUGHNESS_MUL, _T("ReflectionRoughnessMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, ReflectionRoughnessMulDefault,
	p_range, RoughnessMulMin, RoughnessMulMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_ROUGHNESS_MUL,
		IDC_UBER_REFLECTION_ROUGHNESS_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFLECTION_ROUGHNESS, _T("ReflectionRoughness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, ReflectionRoughness,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_ROUGHNESS,
	PB_END,

	FRUBERMTLV2_REFLECTION_ROUGHNESS_MAP, _T("ReflectionRoughnessMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFLECTION_ROUGHNESS,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFLECTION_ROUGHNESS_T,
	PB_END,

	FRUBERMTLV2_REFLECTION_ROUGHNESS_USEMAP, _T("ReflectionRoughnessUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFLECTION_ROUGHNESS_USEMAP,
	PB_END,

	// Reflection Anisotropy
	FRUBERMTLV2_REFLECTION_ANISO_MUL, _T("ReflectionAnisoMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, ReflectionAnisoMulDefault,
	p_range, AnisoMin, AnisoMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_ANISO_MUL,
		IDC_UBER_REFLECTION_ANISO_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFLECTION_ANISO_MAP, _T("ReflectionAnisoMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFLECTION_ANISO,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFLECTION_ANISO_T,
	PB_END,

	FRUBERMTLV2_REFLECTION_ANISO_USEMAP, _T("ReflectionAnisoUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFLECTION_ANISO_USEMAP,
	PB_END,

	// Reflection Anisotropy Rotation
	FRUBERMTLV2_REFLECTION_ANISO_ROT_MUL, _T("ReflectionAnisoRotMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, ReflectionAnisoRotationMulDefault,
	p_range, RotationMin, RotationMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_ANISO_ROT_MUL,
		IDC_UBER_REFLECTION_ANISO_ROT_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFLECTION_ANISO_ROT, _T("ReflectionAnisoRot"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, ReflectionAnisoRotation,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_ANISO_ROT,
	PB_END,

	FRUBERMTLV2_REFLECTION_ANISO_ROT_MAP, _T("ReflectionAnisoRotMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFLECTION_ANISO_ROT,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFLECTION_ANISO_ROT_T,
	PB_END,

	FRUBERMTLV2_REFLECTION_ANISO_ROT_USEMAP, _T("ReflectionAnisoRotUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFLECTION_ANISO_ROT_USEMAP,
	PB_END,

	// Reflection Mode
	FRUBERMTLV2_REFLECTION_MODE, _T("ReflectionMode"), TYPE_INT, P_ANIMATABLE, 0,
	p_default, RPR_UBER_MATERIAL_INPUT_REFLECTION_MODE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_INT_COMBOBOX, IDC_UBER_REFLECTION_MODE, 2, IDS_IOR, IDS_METALNESS,
	p_vals, RPR_UBER_MATERIAL_IOR_MODE_PBR, RPR_UBER_MATERIAL_IOR_MODE_METALNESS,
	PB_END,

	// Reflection IOR
	FRUBERMTLV2_REFLECTION_IOR_MUL, _T("ReflectionIORMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, ReflectionIorMulDefault,
	p_range, IorMulMin, IorMulMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_IOR_MUL,
		IDC_UBER_REFLECTION_IOR_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFLECTION_IOR, _T("ReflectionIOR"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, ReflectionIOR,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_IOR,
	PB_END,

	FRUBERMTLV2_REFLECTION_IOR_MAP, _T("ReflectionIORMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFLECTION_IOR,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFLECTION_IOR_T,
	PB_END,

	FRUBERMTLV2_REFLECTION_IOR_USEMAP, _T("ReflectionIORUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFLECTION_IOR_USEMAP,
	PB_END,

	// Reflection Metalness
	FRUBERMTLV2_REFLECTION_METALNESS_MUL, _T("ReflectionMetalnessMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, ReflectionMetalnessMulDefault,
	p_range, MetalnessMulMin, MetalnessMulMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFLECTION_METALNESS_MUL,
			IDC_UBER_REFLECTION_METALNESS_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFLECTION_METALNESS, _T("ReflectionMetalness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, ReflectionMetalness,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFLECTION_METALNESS,
	PB_END,

	FRUBERMTLV2_REFLECTION_METALNESS_MAP, _T("ReflectionMetalnessMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFLECTION_METALNESS,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFLECTION_METALNESS_T,
	PB_END,

	FRUBERMTLV2_REFLECTION_METALNESS_USEMAP, _T("ReflectionMetalnessUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFLECTION_METALNESS_USEMAP,
	PB_END,

	// Refraction Color
	FRUBERMTLV2_REFRACTION_COLOR_MUL, _T("RefractionColorMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, RefractionColorMulDefault,
	p_range, ColorMulMin, ColorMulMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_COLOR_MUL,
		IDC_UBER_REFRACTION_COLOR_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFRACTION_COLOR, _T("RefractionColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, RefractionColor,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFRACTION_COLOR,
	PB_END,

	FRUBERMTLV2_REFRACTION_COLOR_MAP, _T("RefractionColorTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFRACTION_COLOR,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFRACTION_COLOR_T,
	PB_END,

	FRUBERMTLV2_REFRACTION_COLOR_USEMAP, _T("RefractionColorUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFRACTION_COLOR_USEMAP,
	PB_END,

	// Refraction Weight
	FRUBERMTLV2_REFRACTION_WEIGHT_MUL, _T("RefractionWeightMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, RefractionWeightDefault,
	p_range, WeightMin, WeightMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_WEIGHT_MUL,
		IDC_UBER_REFRACTION_WEIGHT_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFRACTION_WEIGHT, _T("RefractionWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, RefractionWeight,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFRACTION_WEIGHT,
	PB_END,

	FRUBERMTLV2_REFRACTION_WEIGHT_MAP, _T("RefractionWeightTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFRACTION_WEIGHT,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFRACTION_WEIGHT_T,
	PB_END,

	FRUBERMTLV2_REFRACTION_WEIGHT_USEMAP, _T("RefractionWeightUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFRACTION_WEIGHT_USEMAP,
	PB_END,

	// Refraction Roughness
	FRUBERMTLV2_REFRACTION_ROUGHNESS_MUL, _T("RefractionRoughnessMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, RefractionRoughnessMulDefault,
	p_range, RoughnessMulMin, RoughnessMulMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_ROUGHNESS_MUL,
		IDC_UBER_REFRACTION_ROUGHNESS_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFRACTION_ROUGHNESS, _T("RefractionRoughness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, RefractionRoughness,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFRACTION_ROUGHNESS,
	PB_END,

	FRUBERMTLV2_REFRACTION_ROUGHNESS_MAP, _T("RefractionRoughnessMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFRACTION_ROUGHNESS,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFRACTION_ROUGHNESS_T,
	PB_END,

	FRUBERMTLV2_REFRACTION_ROUGHNESS_USEMAP, _T("RefractionRoughnessUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFRACTION_ROUGHNESS_USEMAP,
	PB_END,

	// Refraction IOR
	FRUBERMTLV2_REFRACTION_IOR_MUL, _T("RefractionIORMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, RefractionIorMulDefault,
	p_range, IorMulMin, IorMulMax,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_REFRACTION_IOR_MUL, IDC_UBER_REFRACTION_IOR_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_REFRACTION_IOR, _T("RefractionIOR"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, RefractionIOR,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_COLORSWATCH, IDC_UBER_REFRACTION_IOR,
	PB_END,

	FRUBERMTLV2_REFRACTION_IOR_MAP, _T("RefractionIORMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_REFRACTION_IOR,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_TEXMAPBUTTON, IDC_UBER_REFRACTION_IOR_T,
	PB_END,

	FRUBERMTLV2_REFRACTION_IOR_USEMAP, _T("RefractionIORUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFRACTION_IOR_USEMAP,
	PB_END,

	// Refraction Thin Surface
	FRUBERMTLV2_REFRACTION_THIN_SURFACE, _T("RefractionThinSurface"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, FALSE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFRACTION_THIN_SURFACE,
	PB_END,

	// Refraction link to Reflection
	FRUBERMTLV2_REFRACTION_LINK_TO_REFLECTION, _T("LinkToReflection"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, FALSE,
	p_ui, ROLLOUT_BASIC_PARAMS, TYPE_SINGLECHEKBOX, IDC_UBER_REFRACTION_LINK_TO_REFLECTION,
	p_tooltip, IDS_MTL_UBER2_LINK_TTP,
	PB_END,

	// Coat Color
	FRUBERMTLV2_COAT_COLOR_MUL, _T("CoatColorMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, CoatColorMulDefault,
	p_range, ColorMulMin, ColorMulMax,
	p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_COLOR_MUL, IDC_UBER_COAT_COLOR_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_COAT_COLOR, _T("CoatColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, CoatColor,
	p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_COLOR,
	PB_END,

	FRUBERMTLV2_COAT_COLOR_MAP, _T("CoatColorTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_COAT_COLOR,
	p_ui, ROLLOUT_COATING, TYPE_TEXMAPBUTTON, IDC_UBER_COAT_COLOR_T,
	PB_END,

	FRUBERMTLV2_COAT_COLOR_USEMAP, _T("CoatColorUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_COATING, TYPE_SINGLECHEKBOX, IDC_UBER_COAT_COLOR_USEMAP,
	PB_END,

	// Coat Weight
	FRUBERMTLV2_COAT_WEIGHT_MUL, _T("CoatWeightMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, CoatWeightDefault, p_range, WeightMin, WeightMax,
	p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_WEIGHT_MUL, IDC_UBER_COAT_WEIGHT_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_COAT_WEIGHT, _T("CoatWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, CoatWeight, p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_WEIGHT,
	PB_END,

	FRUBERMTLV2_COAT_WEIGHT_MAP, _T("CoatWeightTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_COAT_WEIGHT,
	p_ui, ROLLOUT_COATING, TYPE_TEXMAPBUTTON, IDC_UBER_COAT_WEIGHT_T,
	PB_END,

	FRUBERMTLV2_COAT_WEIGHT_USEMAP, _T("CoatWeightUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_COATING, TYPE_SINGLECHEKBOX, IDC_UBER_COAT_WEIGHT_USEMAP,
	PB_END,

	// Coat Roughness
	FRUBERMTLV2_COAT_ROUGHNESS_MUL, _T("CoatRoughnessMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, CoatRoughnessMulDefault,
	p_range, RoughnessMulMin, RoughnessMulMax, p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_ROUGHNESS_MUL, IDC_UBER_COAT_ROUGHNESS_MUL_S, SPIN_AUTOSCALE, PB_END,

	FRUBERMTLV2_COAT_ROUGHNESS, _T("CoatRoughness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, CoatRoughness,
	p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_ROUGHNESS,
	PB_END,

	FRUBERMTLV2_COAT_ROUGHNESS_MAP, _T("CoatRoughnessMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_COAT_ROUGHNESS,
	p_ui, ROLLOUT_COATING, TYPE_TEXMAPBUTTON, IDC_UBER_COAT_ROUGHNESS_T,
	PB_END,

	FRUBERMTLV2_COAT_ROUGHNESS_USEMAP, _T("CoatRoughnessUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_COATING, TYPE_SINGLECHEKBOX, IDC_UBER_COAT_ROUGHNESS_USEMAP,
	PB_END,

	// Coat Mode
	FRUBERMTLV2_COAT_MODE, _T("CoatMode"), TYPE_INT, P_ANIMATABLE, 0,
	p_default, RPR_UBER_MATERIAL_INPUT_COATING_MODE,
	p_ui, ROLLOUT_COATING, TYPE_INT_COMBOBOX, IDC_UBER_COAT_MODE, 2, IDS_IOR, IDS_METALNESS,
	p_vals, RPR_UBER_MATERIAL_IOR_MODE_PBR, RPR_UBER_MATERIAL_IOR_MODE_METALNESS,
	PB_END,

	// Coat IOR
	FRUBERMTLV2_COAT_IOR_MUL, _T("CoatIORMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, CoatIorMulDefault,
	p_range, IorMulMin, IorMulMax,
	p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_IOR_MUL, IDC_UBER_COAT_IOR_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_COAT_IOR, _T("CoatIOR"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, CoatIOR,
	p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_IOR,
	PB_END,

	FRUBERMTLV2_COAT_IOR_MAP, _T("CoatIORMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_COAT_IOR,
	p_ui, ROLLOUT_COATING, TYPE_TEXMAPBUTTON, IDC_UBER_COAT_IOR_T,
	PB_END,

	FRUBERMTLV2_COAT_IOR_USEMAP, _T("CoatIORUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_COATING, TYPE_SINGLECHEKBOX, IDC_UBER_COAT_IOR_USEMAP,
	PB_END,

	// Coat Metalness
	FRUBERMTLV2_COAT_METALNESS_MUL, _T("CoatMetalnessMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, CoatMetalnessMulDefault, p_range, MetalnessMulMin, MetalnessMulMax,
	p_ui, ROLLOUT_COATING, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_COAT_METALNESS_MUL, IDC_UBER_COAT_METALNESS_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_COAT_METALNESS, _T("CoatMetalness"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, CoatMetalness,
	p_ui, ROLLOUT_COATING, TYPE_COLORSWATCH, IDC_UBER_COAT_METALNESS,
	PB_END,

	FRUBERMTLV2_COAT_METALNESS_MAP, _T("CoatMetalnessMap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_COAT_METALNESS,
	p_ui, ROLLOUT_COATING, TYPE_TEXMAPBUTTON, IDC_UBER_COAT_METALNESS_T,
	PB_END,

	FRUBERMTLV2_COAT_METALNESS_USEMAP, _T("CoatMetalnessUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_COATING, TYPE_SINGLECHEKBOX, IDC_UBER_COAT_METALNESS_USEMAP,
	PB_END,

	// Use SSS Diffuse Color
	FRUBERMTLV2_USE_SSS_DIFFUSE_COLOR, _T("UseSSSDiffuseColor"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, FALSE,
	p_ui, ROLLOUT_SSS, TYPE_SINGLECHEKBOX, IDC_UBER_SSS_USE_DIFFUSE_COLOR,
	PB_END,

	// SSS Sub-Surface Color
	FRUBERMTLV2_SSS_SUBSURFACE_COLOR_MUL, _T("SSSSubSurfaceColorMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, SssColorMulDefault,
	p_range, ColorMulMin, ColorMulMax, p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_SUBSURFACE_COLOR_MUL,
		IDC_UBER_SSS_SUBSURFACE_COLOR_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_SSS_SUBSURFACE_COLOR, _T("SSSSubSurfaceColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, SssColor,
	p_ui, ROLLOUT_SSS, TYPE_COLORSWATCH, IDC_UBER_SSS_SUBSURFACE_COLOR,
	PB_END,

	FRUBERMTLV2_SSS_SUBSURFACE_COLOR_MAP, _T("SSSColorTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_SSS_SUBSURFACE_COLOR,
	p_ui, ROLLOUT_SSS, TYPE_TEXMAPBUTTON, IDC_UBER_SSS_SUBSURFACE_COLOR_T,
	PB_END,

	FRUBERMTLV2_SSS_SUBSURFACE_COLOR_USEMAP, _T("SSSSubSurfaceColorUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_SSS, TYPE_SINGLECHEKBOX, IDC_UBER_SSS_SUBSURFACE_COLOR_USEMAP,
	PB_END,

	// SSS Weight
	FRUBERMTLV2_SSS_WEIGHT_MUL, _T("SSSWeightMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, SssWeightDefault,
	p_range, WeightMin, WeightMax,
	p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_WEIGHT_MUL,
		IDC_UBER_SSS_WEIGHT_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_SSS_WEIGHT, _T("SSSWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, SssWeight,
	p_ui, ROLLOUT_SSS, TYPE_COLORSWATCH, IDC_UBER_SSS_WEIGHT,
	PB_END,

	FRUBERMTLV2_SSS_WEIGHT_MAP, _T("SSSWeightTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_SSS_WEIGHT,
	p_ui, ROLLOUT_SSS, TYPE_TEXMAPBUTTON, IDC_UBER_SSS_WEIGHT_T,
	PB_END,

	FRUBERMTLV2_SSS_WEIGHT_USEMAP, _T("SSSWeightUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_SSS, TYPE_SINGLECHEKBOX, IDC_UBER_SSS_WEIGHT_USEMAP,
	PB_END,

	// SSS Scatter Color
	FRUBERMTLV2_SSS_SCATTER_COLOR_MUL, _T("SSSScatterColorMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, SssScatterColorMulDefault,
	p_range, ColorMulMin, ColorMulMax,
	p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_SCATTERCOLOR_MUL, IDC_UBER_SSS_SCATTERCOLOR_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_SSS_SCATTER_COLOR, _T("SSSScatterColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, SssScatterColor,
	p_ui, ROLLOUT_SSS, TYPE_COLORSWATCH, IDC_UBER_SSS_SCATTERCOLOR,
	PB_END,

	FRUBERMTLV2_SSS_SCATTER_COLOR_MAP, _T("SSSScatterColorTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_SSS_SCATTER_COLOR,
	p_ui, ROLLOUT_SSS, TYPE_TEXMAPBUTTON, IDC_UBER_SSS_SCATTERCOLOR_T,
	PB_END,

	FRUBERMTLV2_SSS_SCATTER_COLOR_USEMAP, _T("SSSScatterColorUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_SSS, TYPE_SINGLECHEKBOX, IDC_UBER_SSS_SCATTERCOLOR_USEMAP,
	PB_END,

	// SSS Scatter Amount
	FRUBERMTLV2_SSS_SCATTER_AMOUNT_MUL, _T("SSSScatterAmountMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, SssScatterAmountMulDefault,
	p_range, SssScatterAmountMulMin, SssScatterAmountMulMax,
	p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_SCATTERAMOUNT_MUL, IDC_UBER_SSS_SCATTERAMOUNT_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_SSS_SCATTER_AMOUNT_MAP, _T("SSSScatterAmountTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_SSS_SCATTER_AMOUNT,
	p_ui, ROLLOUT_SSS, TYPE_TEXMAPBUTTON, IDC_UBER_SSS_SCATTERAMOUNT_T,
	PB_END,

	FRUBERMTLV2_SSS_SCATTER_AMOUNT_USEMAP, _T("SSSScatterAmountUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_SSS, TYPE_SINGLECHEKBOX, IDC_UBER_SSS_SCATTERAMOUNT_USEMAP,
	PB_END,

	// SSS Directionality
	FRUBERMTLV2_SSS_DIRECTION_MUL, _T("SSSDirectionalityMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, SssScatterDirectionDefault,
	p_range, SssScatterDirectionMin, SssScatterDirectionMax,
	p_ui, ROLLOUT_SSS, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_DIRECTION_MUL, IDC_UBER_SSS_DIRECTION_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_SSS_DIRECTION_MAP, _T("SSSDirectionTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_SSS_DIRECTION,
	p_ui, ROLLOUT_SSS, TYPE_TEXMAPBUTTON, IDC_UBER_SSS_DIRECTION_T,
	PB_END,

	FRUBERMTLV2_SSS_DIRECTION_USEMAP, _T("SSSDirectionUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_SSS, TYPE_SINGLECHEKBOX, IDC_UBER_SSS_DIRECTION_USEMAP,
	PB_END,

	// SSS SingleScattering
	FRUBERMTLV2_SSS_SINGLESCATTERING, _T("UseSSSSingleScattering"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, FALSE,
	p_ui, ROLLOUT_SSS, TYPE_SINGLECHEKBOX, IDC_UBER_SSS_SINGLESCATTERING,
	PB_END,

	// SSS Absorption
	FRUBERMTLV2_SSS_ABSORPTION_MUL, _T("SSSAbsorptionMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, SssAbsorptionMulDefault,
	p_range, SssAbsorptionMulMin, SssAbsorptionMulMax,
	p_ui, ROLLOUT_ABSORPTION, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_ABSORPTION_MUL,
		IDC_UBER_SSS_ABSORPTION_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_SSS_ABSORPTION, _T("SSSAbsorption"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, SssAbsorption,
	p_ui, ROLLOUT_ABSORPTION, TYPE_COLORSWATCH, IDC_UBER_SSS_ABSORPTION,
	PB_END,

	FRUBERMTLV2_SSS_ABSORPTION_MAP, _T("SSSAbsorptionTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_SSS_ABSORPTION,
	p_ui, ROLLOUT_ABSORPTION, TYPE_TEXMAPBUTTON, IDC_UBER_SSS_ABSORPTION_T,
	PB_END,

	FRUBERMTLV2_SSS_ABSORPTION_USEMAP, _T("SSSAbsorptionUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_ABSORPTION, TYPE_SINGLECHEKBOX, IDC_UBER_SSS_ABSORPTION_USEMAP,
	PB_END,

	// SSS Absorption Distance
	FRUBERMTLV2_SSS_ABSORPTION_DIST_MUL, _T("AbsorptionDistanceMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, SssAbsorptionDistanceDefault,
	p_range, SssAbsorptionDistanceMin, SssAbsorptionDistanceMax,
	p_ui, ROLLOUT_ABSORPTION, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_SSS_ABSORPTION_DIST_MUL,
		IDC_UBER_SSS_ABSORPTION_DIST_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_SSS_ABSORPTION_DIST_MAP, _T("SSSAbsorptionDistTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_SSS_ABSORPTION_DIST,
	p_ui, ROLLOUT_ABSORPTION, TYPE_TEXMAPBUTTON, IDC_UBER_SSS_ABSORPTION_DIST_T,
	PB_END,

	FRUBERMTLV2_SSS_ABSORPTION_DIST_USEMAP, _T("SSSAbsorptionDistUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_ABSORPTION, TYPE_SINGLECHEKBOX, IDC_UBER_SSS_ABSORPTION_DIST_USEMAP,
	PB_END,

	// Emissive Color
	FRUBERMTLV2_EMISSIVE_COLOR_MUL, _T("EmissiveColorMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, EmissiveColorMulDefault,
	p_range, ColorMulMin, ColorMulMax,
	p_ui, ROLLOUT_EMISSIVE, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_EMISSIVE_COLOR_MUL,
		IDC_UBER_EMISSIVE_COLOR_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_EMISSIVE_COLOR, _T("EmissiveColor"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, EmissiveColor,
	p_ui, ROLLOUT_EMISSIVE, TYPE_COLORSWATCH, IDC_UBER_EMISSIVE_COLOR,
	PB_END,

	FRUBERMTLV2_EMISSIVE_COLOR_MAP, _T("EmissiveColorTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_EMISSIVE_COLOR,
	p_ui, ROLLOUT_EMISSIVE, TYPE_TEXMAPBUTTON, IDC_UBER_EMISSIVE_COLOR_T,
	PB_END,

	FRUBERMTLV2_EMISSIVE_COLOR_USEMAP, _T("EmissiveColorUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_EMISSIVE, TYPE_SINGLECHEKBOX, IDC_UBER_EMISSIVE_COLOR_USEMAP,
	PB_END,

	// Emissive Weight
	FRUBERMTLV2_EMISSIVE_WEIGHT_MUL, _T("EmissiveWeightMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, EmissiveWeightDefault,
	p_range, WeightMin, WeightMax,
	p_ui, ROLLOUT_EMISSIVE, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_EMISSIVE_WEIGHT_MUL,
		IDC_UBER_EMISSIVE_WEIGHT_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_EMISSIVE_WEIGHT, _T("EmissiveWeight"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, EmissiveWeight,
	p_ui, ROLLOUT_EMISSIVE, TYPE_COLORSWATCH, IDC_UBER_EMISSIVE_WEIGHT,
	PB_END,

	FRUBERMTLV2_EMISSIVE_WEIGHT_MAP, _T("EmissiveWeightTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_EMISSIVE_WEIGHT,
	p_ui, ROLLOUT_EMISSIVE, TYPE_TEXMAPBUTTON, IDC_UBER_EMISSIVE_WEIGHT_T,
	PB_END,

	FRUBERMTLV2_EMISSIVE_WEIGHT_USEMAP, _T("EmissiveWeightUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_EMISSIVE, TYPE_SINGLECHEKBOX, IDC_UBER_EMISSIVE_WEIGHT_USEMAP,
	PB_END,

	// Emissive Doublesided
	FRUBERMTLV2_EMISSIVE_DOUBLESIDED, _T("EmissiveDoubleSided"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, FALSE,
	p_ui, ROLLOUT_EMISSIVE, TYPE_SINGLECHEKBOX, IDC_UBER_EMISSIVE_DOUBLESIDED,
	PB_END,

	// Material Opacity
	FRUBERMTLV2_MAT_OPACITY_MUL, _T("MaterialOpacityMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, OpacityMulDefault,
	p_range, OpacityMulMin, OpacityMulMax,
	p_ui, ROLLOUT_OVERALL, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_MAT_OPACITY_MUL, IDC_UBER_MAT_OPACITY_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_MAT_OPACITY_MAP, _T("MaterialOpacityTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_MAT_OPACITY,
	p_ui, ROLLOUT_OVERALL, TYPE_TEXMAPBUTTON, IDC_UBER_MAT_OPACITY_T,
	PB_END,

	FRUBERMTLV2_MAT_OPACITY_USEMAP, _T("MaterialOpacityUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_OVERALL, TYPE_SINGLECHEKBOX, IDC_UBER_MAT_OPACITY_USEMAP,
	PB_END,

	// Material Normal
	FRUBERMTLV2_MAT_NORMAL_MUL, _T("MaterialNormalMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, NormalMulDefault,
	p_range, NormalMulMin, NormalMulMax,
	p_ui, ROLLOUT_OVERALL, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_MAT_NORMAL_MUL, IDC_UBER_MAT_NORMAL_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_MAT_NORMAL, _T("MaterialNormal"), TYPE_RGBA, P_ANIMATABLE, 0,
	p_default, MaterialNormal,
	p_ui, ROLLOUT_OVERALL, TYPE_COLORSWATCH, IDC_UBER_MAT_NORMAL,
	PB_END,

	FRUBERMTLV2_MAT_NORMAL_MAP, _T("MaterialNormalTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_MAT_NORMAL,
	p_ui, ROLLOUT_OVERALL, TYPE_TEXMAPBUTTON, IDC_UBER_MAT_NORMAL_T,
	PB_END,

	FRUBERMTLV2_MAT_NORMAL_USEMAP, _T("MaterialNormalUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_OVERALL, TYPE_SINGLECHEKBOX, IDC_UBER_MAT_NORMAL_USEMAP,
	PB_END,

	// Material Displace
	FRUBERMTLV2_MAT_DISPLACE_MUL, _T("MaterialDisplaceMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, DisplaceMulDefault,
	p_range, DisplaceMulMin, DisplaceMulMax,
	p_ui, ROLLOUT_OVERALL, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_MAT_DISPLACE_MUL, IDC_UBER_MAT_DISPLACE_MUL_S,
		SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_MAT_DISPLACE_MAP, _T("MaterialDisplaceTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_MAT_DISPLACE,
	p_ui, ROLLOUT_OVERALL, TYPE_TEXMAPBUTTON, IDC_UBER_MAT_DISPLACE_T,
	PB_END,

	FRUBERMTLV2_MAT_DISPLACE_USEMAP, _T("MaterialDisplaceUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_OVERALL, TYPE_SINGLECHEKBOX, IDC_UBER_MAT_DISPLACE_USEMAP,
	PB_END,

	// Material Bump
	FRUBERMTLV2_MAT_BUMP_MUL, _T("MaterialBumpMul"), TYPE_FLOAT, P_ANIMATABLE, 0,
	p_default, BumpMulDefault,
	p_range, BumpMulMin, BumpMulMax,
	p_ui, ROLLOUT_OVERALL, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_UBER_MAT_BUMP_MUL, IDC_UBER_MAT_BUMP_MUL_S, SPIN_AUTOSCALE,
	PB_END,

	FRUBERMTLV2_MAT_BUMP_MAP, _T("MaterialBumpTexmap"), TYPE_TEXMAP, 0, 0,
	p_subtexno, FRUBERMTLV2_MAP_MAT_BUMP,
	p_ui, ROLLOUT_OVERALL, TYPE_TEXMAPBUTTON, IDC_UBER_MAT_BUMP_T,
	PB_END,

	FRUBERMTLV2_MAT_BUMP_USEMAP, _T("MaterialBumpUseMap"), TYPE_BOOL, P_ANIMATABLE, 0,
	p_default, TRUE,
	p_ui, ROLLOUT_OVERALL, TYPE_SINGLECHEKBOX, IDC_UBER_MAT_BUMP_USEMAP,
	PB_END,
...
void FRMTLCLASSNAME(UberMtlv2)::SetupReflection(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOFLAGS);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFLECTION_COLOR, value);
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFLECTION_ANISOTROPY, value);
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFLECTION_ANISOTROPY_ROTATION, value);
	...
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFLECTION_MODE, reflectionMode);

	if (RPR_UBER_MATERIAL_IOR_MODE_PBR == reflectionMode)
	{
		...
		inputId = RPR_UBER_MATERIAL_INPUT_REFLECTION_IOR;
	}
	else if (RPR_UBER_MATERIAL_IOR_MODE_METALNESS == reflectionMode)
	{
		...
		inputId = RPR_UBER_MATERIAL_INPUT_REFLECTION_METALNESS;
	}
	else
	{
...
void FRMTLCLASSNAME(UberMtlv2)::SetupRefraction(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOFLAGS);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFRACTION_COLOR, value);
	...
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_REFRACTION_THIN_SURFACE, bThinSuraface);
}
...
void FRMTLCLASSNAME(UberMtlv2)::SetupCoating(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOFLAGS);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_COATING_COLOR, value);
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_COATING_WEIGHT, value);
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_COATING_ROUGHNESS, value);

	// COATING REFLECTION MODE
	rpr_int inputId = 0;

	int coatingMode = GetFromPb<int>(pblock, FRUBERMTLV2_COAT_MODE);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_COATING_MODE, coatingMode);

	if (coatingMode == RPR_UBER_MATERIAL_IOR_MODE_PBR)
	{
		// IOR
		...
		inputId = RPR_UBER_MATERIAL_INPUT_COATING_IOR;
	}
	else if (coatingMode == RPR_UBER_MATERIAL_IOR_MODE_METALNESS)
	{
		// METALNESS
		...
		inputId = RPR_UBER_MATERIAL_INPUT_COATING_METALNESS;
	}
	else
	{
		// UI is not aligned with the code
...
void FRMTLCLASSNAME(UberMtlv2)::SetupSSS(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOFLAGS);
	shader.SetValue(RPRX_UBER_MATERIAL_SSS_SUBSURFACE_COLOR, value);
#endif
	...
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_SSS_SCATTER_DIRECTION, value);

	// SSS SINGLESCATTERING
	BOOL bSingleScattering = GetFromPb<BOOL>(pblock, FRUBERMTLV2_SSS_SINGLESCATTERING);
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_SSS_MULTISCATTER, bSingleScattering ? 0 : 1);
...
#if (RPR_API_COMPAT < 0x010031000)
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOFLAGS);
	shader.SetValue(RPRX_UBER_MATERIAL_SSS_ABSORPTION_COLOR, value);
#endif
...
#if (RPR_API_COMPAT < 0x010031000)
	value = SetupShaderOrdinary(mtlParser, parameters, MAP_FLAG_NOGAMMA);
	shader.SetValue(RPRX_UBER_MATERIAL_SSS_ABSORPTION_DISTANCE, value);
#endif
}
...
void FRMTLCLASSNAME(UberMtlv2)::SetupEmissive(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	rpr_uint paramValue = bDoubleSided ? 2 : 1;
	shader.SetValue(RPR_UBER_MATERIAL_INPUT_EMISSION_MODE, paramValue);
...
void FRMTLCLASSNAME(UberMtlv2)::SetupMaterial(MaterialParser& mtlParser, frw::Shader& shader)
{
	...
	if ( value.IsNode() ) // a map must be connected
		shader.SetValue(RPRX_UBER_MATERIAL_NORMAL, value);
#endif
	...
	if ( value.IsNode() ) // a map must be connected
		shader.SetValue(RPRX_UBER_MATERIAL_DISPLACEMENT, value);
#endif
	// MATERIAL BUMP
...
#if (RPR_API_COMPAT < 0x010031000)
	if (value.IsNode()) // a map must be connected
		shader.SetValue(RPRX_UBER_MATERIAL_BUMP, value);
#endif
}
...
INT_PTR BasicParamsDlgProc::MsgProcInitDialog(TimeValue t, IParamMap2* map, HWND hDlg, WPARAM wParam, LPARAM lParam)
{
	...
	bool isInvalidSet = ( (RPR_UBER_MATERIAL_IOR_MODE_METALNESS == reflectionMode) && isLinked );
	...
	// setup controls
	if (RPR_UBER_MATERIAL_IOR_MODE_METALNESS == reflectionMode)
	{
