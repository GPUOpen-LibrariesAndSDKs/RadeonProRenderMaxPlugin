...
(
	...
	p_subtexno, FRSHADOWCATCHERMTL_MAP_BACKGROUND_COLOR, p_ui, TYPE_TEXMAPBUTTON, IDC_SC_BACKGROUND_COLOR_MAP, PB_END,
...
std::map<int, std::pair<ParamID, MCHAR*>> FRMTLCLASSNAME(SHADOWCATCHERMtl)::TEXMAP_MAPPING =
{
	...
	{ FRSHADOWCATCHERMTL_MAP_SHADOW_COLOR ,{ FRSHADOWCATCHER_SHADOW_COLOR_MAP , _T("Shadow Color Map") } },
